...
def main():
	...
	def mouse_button_callback(window, button, action, mods):
		if action == glfw.PRESS and cube.picking_mode:
			...
			# Use glReadPixels to read the color at mouse pos
			...
			# Turn off picking mode in the shader
			glUniform1i(glGetUniformLocation(cube.shader, "u_PickingMode"), 0)
			
	def cursor_pos_callback(window, xpos, ypos):
		# If no piece selected, do normal camera controls
